...
### Авто danger_zone по границам дороги (эвристика)

В UI есть опция **«Авто danger_zone (по границам дороги)»**: зона оценивается автоматически по текущему кадру (Canny + Hough по нижней части изображения с дополнительным цветовым фильтром под разметку) и применяется как полигон (трапеция).
