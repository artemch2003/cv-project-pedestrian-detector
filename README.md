...
Мы используем лёгкую эвристику (без нейросегментации):
...
- Ищем отрезки **HoughLinesP**.
- Оставляем две доминирующие линии по наклону: **левая** (наклон < 0) и **правая** (наклон > 0), усредняем их по длине.
- Строим **полигон-коридор** между этими линиями и **заливаем** его — это и есть **маска проезжей части**.
